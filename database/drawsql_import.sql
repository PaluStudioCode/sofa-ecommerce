...
CREATE TABLE `order_shipping_snapshots` (
  ...
  `billable_distance_km` DECIMAL(8, 2) UNSIGNED NOT NULL,
  `shipping_cost` DECIMAL(15, 2) UNSIGNED NOT NULL,
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `order_shipping_snapshots_origin_latitude_origin_longitude_index` (`origin_latitude`, `origin_longitude`),
