...
<template>
    ...
    <AuthenticatedLayout :navigation-groups="navigationGroups" :breadcrumbs="breadcrumbs" title="Pengiriman Internal">
        ...
        <div class="mb-5 grid gap-4 xl:grid-cols-[minmax(0,1fr)_420px]">
            ...
            <form class="rounded-md border border-neutral-border bg-white p-5" @submit.prevent="submitShipment">
                ...
                <div class="mt-4 flex gap-2">
                    ...
                    <AppButton v-if="selectedOrder" type="button" variant="secondary" @click="cancelSelection">Batal</AppButton>
                </div>
            </form>
        </div>
    </AuthenticatedLayout>
